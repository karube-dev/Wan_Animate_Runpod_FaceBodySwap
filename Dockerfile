...
# ===== Face Swap models =====
# InsightFace buffalo_l for face detection (used by ReActor internally)
RUN mkdir -p /ComfyUI/models/insightface/models/buffalo_l

# inswapper_128: core face swap model
RUN wget -q https://huggingface.co/datasets/Gourieff/ReActor/resolve/main/models/inswapper_128.onnx \
...
RUN wget -q https://github.com/TencentARC/GFPGAN/releases/download/v1.3.4/GFPGANv1.4.pth \
    -O /ComfyUI/models/facerestore_models/GFPGANv1.4.pth
RUN wget -q https://github.com/sczhou/CodeFormer/releases/download/v0.1.0/codeformer.pth \
    -O /ComfyUI/models/facerestore_models/codeformer.pth
